...
try:
    ...
    print("🚀 Demonstração: Otimizações RAG")
    print("=" * 60)
    
    # Teste 1: Retriever sem otimizações
    print("\n📊 TESTE 1: Retriever Padrão (sem otimizações)")
    print("-" * 50)
    ...
    print(f"\n  ⏱️ Tempo total: {total_time_normal:.3f}s")
    print(f"  📈 Tempo médio por query: {total_time_normal/len(test_queries):.3f}s")
    
    # Teste 2: Retriever com otimizações
    print("\n\n🔥 TESTE 2: Retriever Otimizado (com cache e otimizações)")
    print("-" * 50)
    ...
    print(f"\n  ⏱️ Tempo total: {total_time_optimized:.3f}s")
    print(f"  📈 Tempo médio por query: {total_time_optimized/len(test_queries):.3f}s")
    ...
    print(f"🔸 Sem otimizações:    {total_time_normal:.3f}s")
    print(f"🔥 Com otimizações:    {total_time_optimized:.3f}s")
    ...
    print("\n\n🎯 BENEFÍCIOS DAS OTIMIZAÇÕES (use_optimizations=True)")
    print("=" * 60)
