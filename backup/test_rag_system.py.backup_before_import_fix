...
# Adicionar o diretório core_logic ao path (subindo um nível da pasta tests)
...
class RAGSystemTester:
        ...
        try:
            ...
            for query in test_queries:
                try:
                    ...
                    print(f"   ⚠️ Erro na consulta '{query}': {e}")
    ...
    def run_all_tests(self) -> Dict[str, Any]:
        ...
        print("\n" + "=" * 60)
        print(f"📊 RELATÓRIO FINAL: {passed}/{total} testes passaram")
        print(f"⏱️ Tempo total: {total_duration:.2f}s")
        
        if passed == total:
            print("🎉 Todos os testes passaram! Sistema RAG está funcionando.")
        else:
